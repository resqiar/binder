...
func CreateExtBody() templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("</div><!-- Youtube URL --><div class=\"form-control\"><label class=\"label\" for=\"yt-input\"><span class=\"label-text\">Youtube Video</span></label> <label class=\"input input-bordered flex items-center gap-2\"><svg xmlns=\"http://www.w3.org/2000/svg\" fill=\"none\" viewBox=\"0 0 24 24\" stroke-width=\"1.5\" stroke=\"currentColor\" class=\"h-5 w-5\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" d=\"M13.19 8.688a4.5 4.5 0 011.242 7.244l-4.5 4.5a4.5 4.5 0 01-6.364-6.364l1.757-1.757m13.35-.622l1.757-1.757a4.5 4.5 0 00-6.364-6.364l-4.5 4.5a4.5 4.5 0 001.242 7.244\"></path></svg> <input type=\"text\" id=\"yt-input\" name=\"ext-yt\" placeholder=\"Youtube video URL\" class=\"grow\"></label></div><!-- CODE INPUT SECTION --><section><label class=\"label\" for=\"editor\"><span class=\"label-text\">Code</span></label><div id=\"editor\" class=\"min-h-[500px] !text-lg\">console.log(hello from the editor i guess)</div></section><div id=\"info-wrapper\"></div><div class=\"my-12 w-full flex justify-end\"><button type=\"submit\" class=\"w-full btn btn-primary\">Create <span id=\"loading\" class=\"loading loading-dots loading-md loading-indicator\"></span></button></div></div></form>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if !templ_7745c5c3_IsBuffer {
